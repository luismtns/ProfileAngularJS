...
include 'lolconfig.php';
 ...
 // PART I. OBTAIN accountId
 
// construct url to grab the accountId
...
else
{
    ...
    if(!empty($summonerDecoded['accountId'])){
        $accountId = $summonerDecoded['accountId'];
    }else{
        die(json_encode(array("error"=>"Usuario")));
    }
}
...
$rankInfoURL = "https://". $region . ".api.riotgames.com/lol/match/v3/matchlists/by-account/". $accountId . "?queue=420&api_key=". $apiKey;
